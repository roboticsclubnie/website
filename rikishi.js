...
if ($(window).width() < 500) {
  $('.navitems ul li a').removeClass('animate__animated').removeClass('animate__fadeInUp').removeClass('').removeClass('').removeClass('');
  $('#club').removeClass('').addClass('');
  $('.flex-wrapper2').removeClass('').addClass('animate__delay-3s');
  for(let i = 1; i <= 6; i++) {
...
window.addEventListener('resize', function () {
  if ($(window).width() >= 500) {
    ...
    $('#club').removeClass('animate__delay-4s').addClass('');
